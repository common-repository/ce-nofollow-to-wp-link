...
( function( $ ) {
	...
	wpLink = {
		...
		// append nofollow checkbox HTML / Pluginmodification
		append : function() {
			var html = '<br /><label><span> </span><input type="checkbox" id="link-nofollow-checkbox" />' + ce_wplink_translation.checkboxlabel + '</label>';
		...
		init: function() {
			...
			inputs.relNofollow = $( '#link-nofollow-checkbox' ); // Pluginmodification
		...
		mceRefresh: function() {
			...
			if ( e = editor.dom.getParent( editor.selection.getNode(), 'A' ) ) {
				...
				// Set rel="nofollow" / Pluginmodification
		...
		getAttrs: function() {
			return {
				...
				rel: inputs.relNofollow.prop( 'checked' ) ? 'nofollow' : '' // Pluginmodification
			};
		},
	...
	$( document ).ready( wpLink.append ); // Pluginmodification
